...
app.use((req, res, next) => {
    res.locals.title = "Generate Name:";
    next();
});
...
app.post("/submit", (req, res) => {
  ...
  //3. Test to make sure that the random words display in the h1 element in index.ejs
   const bandName1 = adj[(Math.floor(Math.random() * adj.length))];
   const bandName2 = noun[(Math.floor(Math.random() * noun.length))];

   res.render("index.ejs", {nameOfBand1: bandName1, nameOfBand2: bandName2});
});
